...
heading \`element\` or a 'strong' \`element\` instead.`,
  ...
  {
    type: 'dont',
    description: `Don't nest Text components inside one another. The styles will
not apply appropriately.`,
    example: (
      <div>
        <Text>
          This is <Text element="strong">strong text that is too small</Text>.
        </Text>
      </div>
    )
  }
